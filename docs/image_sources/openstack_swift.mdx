---
description: Learn about how to connect your OpenStack Object Storage to imgproxy
---
...
For security purposes, you can restrict which Swift containers imgproxy is allowed to access:
...
:::tip
Use `IMGPROXY_SWIFT_ALLOWED_BUCKETS` to create an allowlist of trusted containers, or use `IMGPROXY_SWIFT_DENIED_BUCKETS` to block specific containers. If both are set, allowed containers take precedence.
:::
