...
This option is useful when you want to automatically extract the area containing specific objects from an image, such as extracting all faces from a group photo or isolating products from a catalog image.
