...
If you provide a video as a source, imgproxy Pro takes a specific frame — or a tiled sprite sheet or animated preview built from several frames — to create a thumbnail. To do this, imgproxy downloads only the amount of data required to reach the needed frame(s).
