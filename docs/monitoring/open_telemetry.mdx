...
imgproxy supports the standart [general](https://opentelemetry.io/docs/languages/sdk-configuration/general/) and [OTLP exporter-specific](https://opentelemetry.io/docs/languages/sdk-configuration/otlp-exporter/) environment variables with the following specifics:
