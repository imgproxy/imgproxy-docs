...
* `cache_hits_total`: a counter of the total number of cache hits
* `cache_misses_total`: a counter of the total number of cache misses
* `src_cache_hits_total`: a counter of the total number of source image cache hits
* `src_cache_misses_total`: a counter of the total number of source image cache misses
