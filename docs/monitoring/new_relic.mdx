...
* `workers_utilization`: the percentage of imgproxy's workers utilization. Calculated as `Custom/imgproxy/requests_in_progress / Custom/imgproxy/workers * 100`
...
All metrics names are prefixed with `Custom/imgproxy/`.
