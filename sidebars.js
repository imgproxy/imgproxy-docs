...
const sidebars = {
  tutorialSidebar: [
    ...
    },
    {
      ...
      link: {
        type: 'generated-index',
        description: 'Learn about how to use imgproxy to process images or get images info',
      },
      items: [
        'usage/processing',
        {
    ...
    },
    {
      ...
      link: {
        type: 'generated-index',
        description: 'Learn about how to configure imgproxy to serve images from various sources',
      },
      items: [
    ...
    },
    {
      ...
      link: {
        type: 'generated-index',
        description: 'Learn about how to configure monitoring of your imgproxy instances',
      },
      items: [
