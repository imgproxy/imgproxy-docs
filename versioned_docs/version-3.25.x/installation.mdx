...
imgproxy can be deployed to [Zerops](https://zerops.io/) using their [official recipe](https://github.com/zeropsio/recip):

You can use this import yaml in zerops gui to get started:

```yml
project:
  name: recipe-imgproxy
  tags:
    - zerops-recipe
