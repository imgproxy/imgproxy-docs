---
title: Encrypting a source URL
description: Learn about how to encrypt source image URLs
---

# Encrypting a source URL ((pro))
...
:::info
From this point on, we'll show unprintable characters in `\NN` format where `NN` is a hex representation of the byte.
:::
